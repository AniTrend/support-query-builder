...
| Shared Android/JVM defaults | `buildSrc/.../plugins/components/ProjectConfiguration.kt` | `compileSdk = 36`, `minSdk = 23`, `targetSdk = 35`, Java 21, `JvmTarget.JVM_21` |
...
| KSP processor wiring | `processor/build.gradle.kts`, `processor/src/main/...` | Depends on `:annotations`; uses KotlinPoet, `auto-service`, KSP, and Room compiler headers |
...
- `:processor` — JVM KSP module. Depends on `:annotations`. Uses KotlinPoet, KSP, and `auto-service`.
