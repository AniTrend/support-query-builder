...
- Shared Android defaults come from `buildSrc/.../ProjectConfiguration.kt`, including `compileSdk = 36`, `minSdk = 23`, `targetSdk = 35`, Java 21 compatibility, and `JvmTarget.JVM_21`.
